    ...
    degrees: [
      {
        ...
        year: '2019',
        description: 'Specialization in software development and systems architecture',
      },
      {
        degree: 'Full Stack Certification',
        school: 'Intensive Bootcamp',
        year: '2018',
        description: '6-month intensive program in modern web technologies',
      },
    ],
  },
  projects: {
